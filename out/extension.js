...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("openclaude.newConversation", () => {
        provider["_messages"] = [];
        provider["_postMessage"]({ type: "cleared" });
        vscode.commands.executeCommand("openclaude.chatView.focus");
    }));
    // Command: Add editor context
    context.subscriptions.push(vscode.commands.registerCommand("openclaude.addContext", () => {
